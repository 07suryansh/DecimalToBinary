...
copyIcon1.addEventListener("click", function () {
  ...
  document.getElementById("toast").innerHTML="Copied to clipboard";
  setTimeout(()=>{
    document.getElementById("toast").innerHTML="Enter value for conversion";
  },1000);
});
...
function convertNumberToHexadecimal(number) {
  ...
  document
    ...
    .setAttribute("value", hexadecimalNumber);
}
